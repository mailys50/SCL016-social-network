export const home = () => {
    const divGeneralView = document.createElement("div");
    const viewGeneralView = `
    <div class="generalview">
        ...
        <div class="generalList">aqui imagenes y videos comunidad</div>
        <div class="footer">
          <div class="inicio">
    ...
    divGeneralView.innerHTML = viewGeneralView;
    return divGeneralView;
  };
